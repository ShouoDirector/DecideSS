                ...
                <div class="row gx-0 justify-content-center d-flex mb-3">
                    <div class="col-md-3 border-end shadow mb-3 p-3">
                        <div class="p-4 py-3 py-md-4">
                            ...
                            <h3 class=" mt-2 mb-0">{{ $collectiveData['feedingProgramCount'] }}</h3>
                        </div>
                    </div>
                    <div class="col-md-3 border-end shadow mb-3 p-3">
                        <div class="p-4 py-3 py-md-4">
                            ...
                            <h3 class=" mt-2 mb-0">{{ $collectiveData['dewormingProgramCount'] }}</h3>
                        </div>
                    </div>
                    <div class="col-md-3 border-end shadow mb-3 p-3">
                        <div class="p-4 py-3 py-md-4">
                            ...
                            <h3 class=" mt-2 mb-0">{{ $collectiveData['immunizationVaxProgramCount'] }}</h3>
                        </div>
                    </div>
                    <div class="col-md-3 border-end shadow mb-3 p-3">
                        <div class="p-4 py-3 py-md-4">
                            ...
                            <h3 class=" mt-2 mb-0">{{ $collectiveData['mentalProgramCount'] }}</h3>
                        </div>
                    </div>
                    <div class="col-md-3 border-end shadow mb-3 p-3">
                        <div class="p-4 py-3 py-md-4">
                            ...
                            <h3 class=" mt-2 mb-0">{{ $collectiveData['dentalProgramCount'] }}</h3>
                        </div>
                    </div>
                    <div class="col-md-3 border-end shadow mb-3 p-3">
                        <div class="p-4 py-3 py-md-4">
                            ...
                            <h3 class=" mt-2 mb-0">{{ $collectiveData['eyeProgramCount'] }}</h3>
                        </div>
                    </div>
                    <div class="col-md-3 border-end shadow mb-3 p-3">
                        <div class="p-4 py-3 py-md-4">
                            ...
                            <h3 class=" mt-2 mb-0">{{ $collectiveData['wellnessProgramCount'] }}</h3>
                        </div>
                    </div>
                    <div class="col-md-3 border-end shadow mb-3 p-3">
                        <div class="p-4 py-3 py-md-4">
                            ...
                            <h3 class=" mt-2 mb-0">{{ $collectiveData['medicalProgramCount'] }}</h3>
                        </div>
                    </div>
                    <div class="col-md-3 border-end shadow mb-3 p-3">
                        <div class="p-4 py-3 py-md-4">
                            ...
                            <h3 class=" mt-2 mb-0">{{ $collectiveData['nursingProgramCount'] }}</h3>
                        </div>
                    </div>
