<div class="card d-flex shadow-none row flex-row m-0">
    <div class="btn-toolbar d-flex justify-content-end" role="toolbar" aria-label="Toolbar with button groups">
        <div class="btn-group mb-2" role="group" aria-label="First group" style="align-items: center;">
            <div class=" col-auto">
                <form action="{{ route('school_nurse.school_nurse.past_reports') }}">
                    {{ csrf_field() }}
            ...
            <a href="{{ route('school_nurse.school_nurse.past_reports') }}" type="button" class="btn btn-secondary"
    ...
    <div class="d-flex justify-content-end my-2">
            ...
            <form action="{{ route('school_nurse.school_nurse.past_reports') }}" method="GET">
                {{ csrf_field() }}
                <input type="text" name="search" class="d-none" value="{{ Request::get('search') }}">
                <input type="text" name="schoolYear" class="d-none" value="{{ Request::get('schoolYear') }}">
                ...
                <form action="{{ route('school_nurse.school_nurse.past_reports') }}" class="me-1">
                    {{ csrf_field() }}
                    <input type="text" name="search" class="d-none" value="{{ Request::get('search') }}">
                    <input type="text" name="schoolYear" class="d-none" value="{{ Request::get('schoolYear') }}">
