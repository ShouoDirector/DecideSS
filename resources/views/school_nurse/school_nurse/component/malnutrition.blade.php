    ...
    <div class="table-responsive w-100 pb-3">
        <table class="table border table-striped table-bordered text-nowrap">
            ...
            <tbody>
                ...
                <!-- start row -->
                @foreach($dataProgram['getRecord'] as $value)
                @if($value->bmi_category == 'Severely Wasted' || $value->bmi_category == 'Wasted')
                <tr>
                    <td> {{ $loop->iteration }} </td>
                    <td> {{ $dataPupilLRNs[$value->pupil_id] }} </td>
                    <td> {{ $dataPupilNames[$value->pupil_id] }} </td>
    ...
    <div class="table-responsive w-100 pb-3">
        <table class="table border table-striped table-bordered text-nowrap">
            ...
            <tbody>
                ...
                <!-- start row -->
                @foreach($dataProgram['getRecord'] as $value)
                @if($value->bmi_category == 'Overweight' || $value->bmi_category == 'Obese')
                <tr>
                    <td> {{ $loop->iteration }} </td>
                    <td> {{ $dataPupilLRNs[$value->pupil_id] }} </td>
                    <td> {{ $dataPupilNames[$value->pupil_id] }} </td>
