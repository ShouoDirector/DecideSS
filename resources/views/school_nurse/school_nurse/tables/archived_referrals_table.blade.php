                ...
                <div class="dropdown dropstart">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li>
                                ...
                                data-bs-toggle="modal" data-bs-target="#unarchive-referral-modal">
                                    <i class="fs-4 ti ti-trash"></i>Unarchive</button>
                            </li>
                        </ul>
                        @include('school_nurse.school_nurse.modals.unarchive-referral-modal')
                    </div>
            </td>
            </tr>
            @endforeach
