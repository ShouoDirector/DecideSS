<div class="table w-100 p-0 pb-3">
    <h5 class="text-center fw-bolder">HEALTHCARE SERVICES REPORT OF {{ strtoupper($schoolName[Request::get('search')]) }}</h5>
    <h6 class="text-center">{{ strtoupper($districtName[$districtId[Request::get('search')]]) }} DISTRICT</h6>
