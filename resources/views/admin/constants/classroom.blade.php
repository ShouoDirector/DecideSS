            ...
            <div class="card-body w-100">
                ...
                <div class="tab-content">
                        ...
                        <div class="col-12 d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div class="d-flex w-100 justify-content-end gap-2">
                                    ...
                                    <div class="btn-group">
                                            <button type="button" class="btn btn-primary dropdown-toggle py-2 ps-5 pe-5" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li class="max-content p-1"><form action="{{ route('admin.constants.classroom') }}">
                                    ...
                                    <div class="justify-content-end">
                                        <a role="button" href="{{ route('admin.constants.classroom') }}" type="submit" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Clear">
                    ...
                    <div class="tab-pane p-3" id="profile2" role="tabpanel">
                        ...
                        <!-- ================================ SIDE FORM - CLASSROOM ================================================ -->
                        @include('admin.constants.forms.classroom-form')
