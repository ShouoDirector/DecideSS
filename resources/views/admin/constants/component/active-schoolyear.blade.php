<div class="col-12 d-flex align-items-stretch w-100">
    <div
        class="col-lg-3 col-md-4 col-sm-6 col-12 card card-hover border-bottom border-primary card-shadow position-relative overflow-hidden">
        <div class="card-body px-3 py-3">
            <div class="ms-1 mt-2 d-flex row">
                <div
