                    ...
                    <div class="p-3">
                        ...
                        <div class="col-12 d-flex justify-content-between align-items-center mb-4">
                            <button type="button"
                                ...
                                {{ $head['headerTitle'] }}
                                <span
                                    class="badge ms-auto bg-primary">{{ $dataSection['getList']->count() }}</span>
                            </button>
                            <div class="d-flex w-100 justify-content-end gap-2">
                                <div class="f-flex row gap-2 justify-content-end">
                                    <div class="f-flex row gap-2 justify-content-end">
                                        <form action="{{ route('admin.constants.manage_sections') }}">
                                ...
                                <div class="justify-content-end">
                                    <a role="button" href="{{ route('admin.constants.manage_sections') }}" type="submit"
                        ...
                        <!-- ========================================= SECTION TABLE ====================================== -->
                        @include('admin.constants.tables.section-table')
