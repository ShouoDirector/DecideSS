                            ...
                            <div class="col-12 d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div class="d-flex w-100 justify-content-end gap-2">
                                    ...
                                    <div class="justify-content-end">
                                        <a role="button" href="{{ route('admin.constants.districts') }}" type="submit" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Clear">
