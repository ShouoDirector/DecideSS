<div class="col-12 card position-relative overflow-hidden pb-3" id="school">
    <div class="row d-flex justify-content-between card-body pt-4 ps-3">
        <h5 class="col-auto">{{ $head['headerFilter2'] }}</h5>
        <a class="col-auto" href="#district"><i class="ti ti-caret-up col-auto fs-5"></i></a>
    </div>
            ...
            <div class="row d-flex col-lg-9 col-12">
                ...
                <div class="form-group row d-flex align-items-center ps-4">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="form-check form-check-inline mb-2">
                            <input class="form-check-input" type="radio" name="sort_field" id="nameSort" value="school"
                                {{ Request::get('sort_field') == 'school' ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-check-inline mb-2">
                            <input class="form-check-input" type="radio" name="sort_field" id="nameSort"
                                ...
                                {{ Request::get('sort_field') == 'address_barangay' ? 'checked' : '' }}>
