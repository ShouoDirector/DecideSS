<div class="col-12 card position-relative overflow-hidden pb-3">
    ...
    <div class="d-flex row card-body d-flex justify-between p-0">
        <form class="d-flex row col-12 justify-content-between" method="get" action="{{ route('admin.admin.list') }}"
            id="userFilterForm">
            ...
            <div class="row d-flex col-lg-9 col-12">
                ...
                <div class="form-group row d-flex align-items-center ps-4">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="form-check form-check-inline mb-2">
                            <input class="form-check-input" type="radio" name="sort_field" id="nameSort" value="name"
                                {{ Request::get('sort_field') == 'name' ? 'checked' : '' }}>
                            <label class="form-check-label" for="nameSort">Name</label>
                        </div>
                        <div class="form-check form-check-inline mb-2">
                            <input class="form-check-input" type="radio" name="sort_field" id="emailSort" value="email"
                                {{ Request::get('sort_field') == 'email' ? 'checked' : '' }}>
