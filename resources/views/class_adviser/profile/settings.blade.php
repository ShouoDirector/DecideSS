                            ...
                            <div class="col-lg-6 d-flex align-items-stretch">
                                <div class="card overflow-hidden">
                                    <div class="card-body p-0">
                                        <img src="{{ asset('dist/images/backgrounds/profilebg.jpg') }}" alt=""
                                            class="img-fluid">
                                        <div class="row align-items-center justify-content-center m-0 p-0">
                                            ...
                                            <div class="col-lg-4 order-last text-end">
                                                <a href="#collapseTwo" class="btn" type="button"
                                        ...
                                        <form action="{{ route('class_adviser.profile.saveSettings') }}" method="post">
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <label><i class="ti ti-lock me-2 fs-4 text-info"></i><span
                                                        class="border-start border-info ps-3">Current
                                                        Password</span></label>
                                            </div>
                                            ...
                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control border border-info"
                                                    ...
                                                    required>
                                                <label><i class="ti ti-lock me-2 fs-4 text-info"></i><span
                                                        class="border-start border-info ps-3">New
                                                        Password</span></label>
                                            </div>
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <label><i class="ti ti-lock me-2 fs-4 text-info"></i><span
                                                        class="border-start border-info ps-3">Confirm
                                                        Password</span></label>
                                            </div>

                                            <!-- Submit Button -->
                                            <button type="submit" class="btn btn-primary w-100 p-2">Change
                                                Password</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            <div id="collapseTwo" class="col-12" aria-labelledby="headingTwo"
