                        ...
                        <div class="col-12 d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div class="d-flex w-100 justify-content-end gap-2">
                                    ...
                                    <div class="btn-group">
                                            <button type="button" class="btn btn-primary dropdown-toggle py-2 ps-5 pe-5" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li class="max-content p-1"><form action="{{ route('school_nurse.school_nurse.pupils') }}">
                                    ...
                                    <div class="justify-content-end">
                                        <a role="button" href="{{ route('school_nurse.school_nurse.pupils') }}" type="submit" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Clear">
