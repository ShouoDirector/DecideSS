...
<div class="d-flex row m-0 justify-content-end mt-4 mb-4">
                ...
                <a href="{{ route('class_adviser.class_adviser.report_approval') }}" type="button" class="btn btn-outline-primary rounded-0 d-flex col-lg-2 col-md-4 col-sm-6 justify-content-center">Review & Submit</a>
                <a href="#" type="button" class="btn btn-primary rounded-0 d-flex col-lg-2 col-md-4 col-sm-6 justify-content-center">Nutritional Status Report</a>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex flex-column align-items-baseline justify-content-center">
                            <form class="d-flex row col-12 w-auto" action="{{ route('class_adviser.class_adviser.approved_report') }}">
                                <div class="hidden">
