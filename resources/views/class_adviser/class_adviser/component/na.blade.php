<div class="d-flex shadow-none row w-100 m-0">
    ...
    <div class="col-12 shadow-none">
        <div class="card-body w-100">
            ...
            <div class="d-flex row m-0 justify-content-end mt-4 mb-4">
                <a href="{{ route('class_adviser.class_adviser.report_approval') }}" class="btn btn-outline-primary rounded-0 d-flex col-lg-3 col-md-5 col-sm-7 justify-content-center">
                    Review & Approve
                </a>
