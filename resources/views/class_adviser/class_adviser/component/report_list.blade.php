<div class="card shadow-none">
    ...
    <div class="card-body py-0">
        <div class="d-flex align-items-center">
            <h4 class="card-title">Your
                @if ($filteredRecords->count() > 1)
                Classes
                @elseif($filteredRecords->count() == 1)
                Class
                @else
                <!-- Handle the case when count is not greater than 1 and not equal to 1 -->
                @endif
                in School Year
                {{ $activeSchoolYear['getRecord']->first()->school_year }} |
                {{ $activeSchoolYear['getRecord']->first()->phase }}
            </h4>
        </div>
        ...
        <div class="table-responsive">
            ...
            <table class="table stylish-table v-middle mb-0 text-nowrap">
                ...
                <tbody>
                    <tr class="{{ $sectionIds->contains($record->id) ? '' : 'hidden' }}">
                        <td>
                            <span
                        ...
                        <span class="badge px-3 py-2 card-hover
                        ...
                        <td class="d-flex flex-column align-items-baseline justify-content-center">
                            <form class="d-flex row col-12 w-auto" action="{{ route('class_adviser.class_adviser.report_approval') }}">
                                <div class="hidden">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active show" id="home2" role="tabpanel">
                    <div class="p-3">
                        ...
                        <!-- =========================================TABLE FILTER - PUPILS ====================================== -->
                        @if(count($dataClassRecord['getRecord']) !== 0)
                        @include('class_adviser.class_adviser.component.classes_list')
                        <!-- ========================================= REPORT TABLE ====================================== -->
                        @include('class_adviser.class_adviser.tables.report_list')
                        @else
                        @endif
