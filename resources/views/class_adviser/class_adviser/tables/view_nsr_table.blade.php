                                ...
                                <div class="theme-option pb-4">
                                    <div class="d-flex justify-content-end my-2">
                                        <div class="btn-group mb-2 p-0 m-0" role="group" aria-label="Basic example">
                                            <form action="{{ route('class_adviser.class_adviser.view_nsr') }}">
                                                {{ csrf_field() }}
...
<div class="w-100 pb-3">
    <table class="table border table-striped text-nowrap">
        <thead>
            <!-- start row -->
            <tr>
                <th></th>
    ...
    <div class="d-flex justify-content-end text-dark">
                    @foreach($dataNSRLists as $record)
                    Version : #NSR-{{ $record->version }}-{{ $record->nsr_code }}
                    @endforeach
                </div>
