<form class="" method="post" action="{{ route('class_adviser.class_adviser.pupil_update', ['id' => $data['getPupilRecord']->id]) }}" id="userForm">
    {{ csrf_field() }}
    ...
    <div class="form-floating mb-3">
        ...
        <label><i class="ti ti-user me-2 fs-4 text-info"></i><span class="border-start border-info ps-3">LRN</span></label>
    </div>
    <div class="form-floating mb-3">
        ...
        <label><i class="ti ti-user me-2 fs-4 text-info"></i><span class="border-start border-info ps-3">Last Name</span></label>
    </div>
    <div class="form-floating mb-3">
        ...
        <label><i class="ti ti-user me-2 fs-4 text-info"></i><span class="border-start border-info ps-3">First Name</span></label>
    </div>
    <div class="form-floating mb-3">
        ...
        <label><i class="ti ti-user me-2 fs-4 text-info"></i><span class="border-start border-info ps-3">Middle Name</span></label>
    </div>
    <div class="form-floating mb-3">
        ...
        <label><i class="ti ti-user me-2 fs-4 text-info"></i><span class="border-start border-info ps-3">Suffix</span></label>
    </div>
    <div class="form-floating mb-3">
        ...
        <label><i class="ti ti-user me-2 fs-4 text-info"></i><span class="border-start border-info ps-3">BirthDate</span></label>
    </div>
    <div class="mb-3">
    ...
    <div class="form-floating mb-3">
        ...
        <label><i class="ti ti-user me-2 fs-4 text-info"></i><span class="border-start border-info ps-3">Barangay</span></label>
    </div>
    <div class="form-floating mb-3">
        ...
        <label><i class="ti ti-user me-2 fs-4 text-info"></i><span class="border-start border-info ps-3">Municipality/City</span></label>
    </div>
    <div class="form-floating mb-3">
        ...
        <label><i class="ti ti-user me-2 fs-4 text-info"></i><span class="border-start border-info ps-3">Province</span></label>
    </div>
    <div class="form-floating mb-3">
        ...
        <label><i class="ti ti-user me-2 fs-4 text-info"></i><span class="border-start border-info ps-3">Guardian Name</span></label>
    </div>
    <div class="form-floating mb-3">
        ...
        <label><i class="ti ti-user me-2 fs-4 text-info"></i><span class="border-start border-info ps-3">Guardian Phone Number</span></label>
    </div>
